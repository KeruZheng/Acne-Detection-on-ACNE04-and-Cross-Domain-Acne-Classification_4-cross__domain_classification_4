...
def main(args):
    ...
    transform = transforms.Compose([
        ...
        # 对应 data.yaml 中的 hsv 相关增强
        transforms.ColorJitter(brightness=0.4,  # 对应 hsv_v（近似用亮度体现明度）
                               contrast=0.3, 
                               saturation=0.7,  # 对应 hsv_s
                               hue=0.015),  # 对应 hsv_h
        transforms.RandomHorizontalFlip(p=0.5),  # 对应 fliplr
        transforms.RandomVerticalFlip(p=0.5),  # 对应 flipud
